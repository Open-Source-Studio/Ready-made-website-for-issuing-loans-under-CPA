...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'zaim240123_webstudionru_f2aac2145803b33f3951_20230124104902_archive.zip';
        const ARCHIVE_SIZE       = '73437854';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f2aac21-24104902';
        const SECONDARY_PACKAGE_HASH = 'b8723d3-24104902';
        const VERSION            = '1.5.0';
